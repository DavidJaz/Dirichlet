...
sums of contravariant representables \emph{Dirichlet functors}. Readers who prefer more traditional algebraic notation can see \cite{SpivakMyers}, which was the set-theoretic inspiration for the present paper.\dis{Agree?}
