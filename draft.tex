...
category $\Set^{\down}$ of bundles of sets and univariant bundle maps.
...
\begin{defn}\label{def.extent}
  ...
  \dis{I worry about the size of $\Fun(\Set\op,\Set)$.}
  This functor admits a right adjoint by right Kan extension along $!_0$; we define the
...
\item The functor
  ...
  \Set$ over $S$.\dis{Is this Emily's notation for comma category?}
\item The functor
