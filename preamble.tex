...
\usepackage{tikz-cd}
\usepackage[margin=1.3in]{geometry} % To shape the margins
...
\DeclareMathOperator{\Dir}{\type{Dir}}
\DeclareMathOperator{\Poly}{\type{Poly}}
\DeclareMathOperator{\Fun}{\type{Fun}}
\DeclareMathOperator{\ext}{\term{ext}}
\DeclareMathOperator{\DirSeries}{\type{DirSeries}}
\DeclareMathOperator{\dom}{\term{dom}}
\DeclareMathOperator{\cod}{\term{cod}}
...
%%% Categories
\DeclareMathOperator{\Set}{\type{Set}}
...
%%% DIS
\newcommand{\dis}[1]{{\color{blue} DIS says:\ #1}}
\newcommand{\jaz}[1]{{\color{red} Jaz says:\ #1}}
